            ...
            items: [{
                ...
                items: [
                    /*{
                        ...
                        height: 46,
                        width: 640,
                        //html: '<div style="text-align:left;color:white;font-size:24px;padding-top:5px;margin-left:10px;">News & Events</div>',
                        ...
                        itemTpl: '{f_title}<div style="font-size:10px;color:grey;magrin-top:2px">{created_date},{f_created_date}</div>',
                        itemId: 'newslist',
						style: 'text-transform:none;',
                        listeners: {
