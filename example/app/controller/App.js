Ext.define('mobileV1.controller.App',{
	...
	naviTap: function(record){
		...
		switch(record.data.type){				
			...
			case 'shoppingcart':
				Ext.getCmp('maintab').setActiveItem(4);
				sessionStorage.userpage = 'shoppingcart';
				...
				if(sessionStorage.userid == 0 || sessionStorage.userid === undefined){
					...
					Ext.getCmp('userontainer').removeAll();
					Ext.getCmp('userontainer').add({xtype: 'shoppingcartview'});
					sessionStorage.shoppingcart = 1;
				}
				break;
			case 'signup':
				Ext.getCmp('maintab').setActiveItem(4);
				sessionStorage.userpage = 'signup';
				...
				if(sessionStorage.userid == 0 || sessionStorage.userid === undefined){
					...
					Ext.getCmp('userontainer').removeAll();
					Ext.getCmp('userontainer').add({xtype: 'signupview'});
					sessionStorage.signup = 1;
				}
				break;
			case 'history':
				Ext.getCmp('maintab').setActiveItem(4);
